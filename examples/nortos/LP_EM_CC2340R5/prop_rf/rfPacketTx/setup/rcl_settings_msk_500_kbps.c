...
// PHY                         2.4 GHz - Proprietary - 500 kbps, MSK
// PHY abbreviation            msk_500_kbps
//
//
// PHY PROPERTIES
//
...
#include "rcl_settings_msk_500_kbps.h"
...
static const uint32_t fixedLenSetup[] =
{
    0x00000003, /* 3 entries */
    LRF_SETTINGS_16BIT_SPARSE_BLOCK((volatile unsigned short*) PBE_GENERIC_RAM_LENCFG_ADR, 2), /* 2 sparse mode writes */
    LRF_SETTINGS_16BIT_SPARSE_ENTRY((volatile unsigned short*) PBE_GENERIC_RAM_PKTCFG_ADR, 0x0080), /* Set 0 header bits */
    LRF_SETTINGS_16BIT_SPARSE_ENTRY((volatile unsigned short*) PBE_GENERIC_RAM_LENCFG_ADR, 0x0000), /* Set 0 length bits */
};
#endif
...
{
    0x0000005A,                                // Segment length = 90
    0x0000A002,                                //     Data structure 32-bit region (start byte position = 0, count = 3)
    (uint32_t) &LRF_swConfigMsk500Kbps,        //         LRF_swParam : swConfig
    (uint32_t) &LRF_txPowerTableMsk500Kbps,    //         LRF_swParam : txPowerTable
    ...
    0x00005584,                                //         LRFDMDM.DEMIQMC0                    LRFDMDM.DEMMISC3
    0x06708D12,                                //         LRFDMDM.DEMCODC0                    LRFDMDM.DEMDSBU
    ...
    0x000F00C2,                                //         LRFDMDM.DEMC1BE0                    LRFDMDM.DEMMAFI2
    0x017F7F28,                                //         LRFDMDM.DEMC1BE2                    LRFDMDM.DEMC1BE1
    0x50000A18,                                //         LRFDMDM.SPARE1                      LRFDMDM.SPARE0
    ...
    0x00100780,                                //         PBE_GENERIC_RAM.NUMCRCBITS          PBE_GENERIC_RAM.PKTCFG
    ...
    0x00000000,                                //         PBE_GENERIC_RAM.LENOFFSET           PBE_GENERIC_RAM.LENCFG
    0x00007001,                                //     RAM sparse region (address/value pairs, count = 2)
    0x20440005,                                //         PBE_GENERIC_RAM.MAXLEN
    0x683E0053,                                //         RFE_COMMON_RAM.PHYRSSIOFFSET
...
#ifdef FIXED_LENGTH_SETUP
    .numEntries = 2,
#elif defined(VARIABLE_LENGTH_SETUP)
    .numEntries = 1,
#endif
    .entries = {
...
const LRF_SwConfig LRF_swConfigMsk500Kbps = {
...
const LRF_TxPowerTable LRF_txPowerTableMsk500Kbps = {
...
const LRF_Config LRF_configMsk500Kbps = {
