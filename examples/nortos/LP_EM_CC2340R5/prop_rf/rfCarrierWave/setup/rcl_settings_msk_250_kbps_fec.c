...
#include "rcl_settings_msk_250_kbps_fec.h"
...
static const uint32_t LRF_commonRegConfig[] =
{
    ...
    (uint32_t) &LRF_swConfigMsk250KbpsFec,        //         LRF_swParam : swConfig
    (uint32_t) &LRF_txPowerTableMsk250KbpsFec,    //         LRF_swParam : txPowerTable
...
const LRF_SwConfig LRF_swConfigMsk250KbpsFec = {
...
const LRF_TxPowerTable LRF_txPowerTableMsk250KbpsFec = {
...
const LRF_Config LRF_configMsk250KbpsFec = {
